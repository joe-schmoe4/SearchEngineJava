...
//		// of the "true" entries.
//		int row = Collections.binarySearch(mVocabulary, term);
//
//		// Scans the columns of the term and if it's true, then it adds them to a list of posting.
//		for (int i=0; i <= mCorpusSize - 1 ; i++){
//			if (mMatrix[row][i] == true){
